...
from backend.app.repository.base_repository import atualizar_objeto
from backend.app.repository.manutencao_repository import buscar_quilometragem_manutencao_anterior,buscar_quilometragem_manutencao_posterior
from backend.app.repository.abastecimento_repository import buscar_quilometragem_abastecimento_anterior,buscar_quilometragem_abastecimento_posterior
from backend.app.repository.dia_de_trabalho_repositorio import buscar_quilometragem_dia_de_trabalho_anterior,buscar_quilometragem_dia_de_trabalho_posterior
from backend.app.schermas.moto_scherma import MotoKmUpdate
...
def atualizar_quilometragem_service(moto:Moto,km_nova:int,session:Session):
